...
You can can either go into the Support forum, or in the [WP GlottyPoMo Repository](https://github.com/mcguffin/wp-glottypomo).

= I'd like to suggest a feature. Where should I post it? =

I personally prefer GitHub. The plugin code is here: [GitHub](https://github.com/mcguffin/wp-glottypomo)
(See above as well.)
...
3. type `git clone git@github.com:mcguffin/wp-glottypomo.git`
...
Either post it on the [GitHub-repo](https://github.com/mcguffin/wp-glottypomo) or—if you cloned the repository—send me a pull request.
